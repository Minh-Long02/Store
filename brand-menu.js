(() => {
    ...
    const sidebar = document.querySelector('.collection-sidebar, .product-sidebar, .brand-sidebar, .shipping-page > .home-sidebar');
    const header = document.querySelector('.collection-header, .product-header, .shipping-page > .shipping-header, .site-header');

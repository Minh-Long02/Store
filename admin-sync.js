...
if (content) {
    ...
    const values = { announcementBar: content.announcement, aboutText: content.about, aboutBody: content.about, footerEmail: content.email, footerCopyright: content.copyright, footerLocation: content.location, footerLegal: content.legal };
